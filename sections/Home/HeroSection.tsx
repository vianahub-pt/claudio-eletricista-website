      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
            Serviços de <span className="text-blue-700">Eletricista</span> e{" "}
            <span className="text-blue-700">Picheleiro</span> de Confiança
          </h1>

          <p className="text-xl mb-8 text-gray-700">
            Soluções profissionais para instalações elétricas e canalizações em Oliveira de Azeméis e arredores.
          </p>
